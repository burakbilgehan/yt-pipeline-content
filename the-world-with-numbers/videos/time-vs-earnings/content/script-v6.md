...
> version: script-v6
> based_on: script-v5
> changes_from_prev: Rewrote closing section — replaced abstract philosophical ending with concrete, embodied human image (two workers on opposite ends of the chart). Removed <prosody rate="slow"> tag (unreliable in Chirp 3 HD). Kept bookend structure. ~1,510 spoken words.
> date: 2026-03-23

## Metadata
- **Word count:** ~1,510 spoken words (voiceover only, SSML stripped)
- **Estimated duration:** ~11:00 at speed 1.15 (639s speech + pauses)
...
[VISUAL NOTE] The full quadrant is visible with all 34 OECD dots. Then the camera slowly zooms OUT — the axes extend. The X-axis stretches past 2,500 hours. The Y-axis drops below $12,000. Six new dots appear in a cluster at the far bottom-right — deep red color, different marker shape (squares instead of circles). They're labeled one by one: India, Bangladesh, Cambodia, Pakistan, Nigeria, Philippines. A small disclaimer text appears in the corner: "Non-OECD data: World Bank GNI per capita (PPP) + ILO hours. Different methodology." Connector line from Germany to Cambodia spans the entire chart diagonally. Stats: "22.5× more per hour | 1,049 fewer hours." The OECD origin crosshair ($59,200 / 1,633 hrs) stays in place — these new dots are far below and far to the right of it.
...
[VISUAL NOTE] TWO-PHASE CLOSING. Phase A: The full chart stays visible from the Ugly Truth section — all 40 countries. All dots except Luxembourg and Cambodia fade. The two remaining dots pulse gently on opposite ends of the chart, tooltips visible. This holds through the first paragraph ("Forty countries... at sixty-four dollars each."). Phase B: The chart fades out. Stock video montage: factory workers in a developing country → sunrise over a modern city skyline → Earth from space with night lights. The question from the hook returns as text overlay: "What is one hour of your life worth?" Hold. Fade to black.
...
<break time="600ms"/>
Right now, somewhere in Cambodia, someone is starting their ninth hour of the day. They'll earn about two dollars and thirty cents for it. Somewhere in Luxembourg, someone just clocked out after six hours — at sixty-four dollars each.
</p>
<break time="400ms"/>
<p>
Same planet. Same twenty-four hours. The single biggest predictor of which quadrant you land in... is not how hard you work. Not how many hours you put in.
<break time="600ms"/>
